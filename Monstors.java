...
public class Monstors {
	...
	public void moveMonster(Monstors [] monster, int arrayItemIndex){
		...
		while(isSpaceOpen){
			...
			if (randMoveDirection == 0){
				...
				if((this.xPosition +randMoveDistance) >maxXBoardSpace){
					...
					this.yPosition = xPosition + randMoveDistance;
				}
				...
				if((this.xPosition - randMoveDirection)<0){
	...
	public boolean onMySpace(Monstors [] monster, int indexToChk1, int indexToChk2){
	...
	public Monstors(int newHealth,int newAttack,int newMovement, String name){
